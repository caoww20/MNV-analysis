...
def createAnnoDict(annotation_list):
    # circRNA	1	24738	24891	hsa_circ_0009177	.	hsa_circ_0009177	circBase
    annotation_dict = {}
...
print('[' + time.strftime("%H:%M:%S", time.localtime()) + '] ' + 'Run MNVAnnoNon.py')
########Load parameters############################################################
...
result.close()
####################################################################
print('[' + time.strftime("%H:%M:%S", time.localtime()) + '] ' + 'End MNVAnnoNon.py')
